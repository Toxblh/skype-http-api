...
export type IdentityCheckRequired = Incident<IdentityCheckRequired.Data,
  IdentityCheckRequired.Name, IdentityCheckRequired.Cause>;

export namespace IdentityCheckRequired {
  export type Type = IdentityCheckRequired;

  export function format() {
    return "The log in request was made from a new location, " +
